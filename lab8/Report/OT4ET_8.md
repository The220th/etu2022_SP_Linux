...
``` bash
the220th@mainPC ~/git/etu2022_SP_Linux/lab8> g++ main.cpp -o main
the220th@mainPC ~/git/etu2022_SP_Linux/lab8> ./main
Syntax error. Expected: "> ./main {prognum_num} {queue_key}"
the220th@mainPC ~/git/etu2022_SP_Linux/lab8> ./main 0 111
...
``` bash
the220th@mainPC ~/git/etu2022_SP_Linux/lab8> ./main 1 111
...
``` bash
the220th@mainPC ~/git/etu2022_SP_Linux/lab8> ./main 2 111
There was an attachment to the queue with key = 111. Its id = 65. 
...
the220th@mainPC ~/git/etu2022_SP_Linux/lab8> ./main 
Syntax error. Expected: "> ./main {prognum_num} {queue_key}"
the220th@mainPC ~/git/etu2022_SP_Linux/lab8> ./main 0 110
...
``` bash
the220th@mainPC ~/git/etu2022_SP_Linux/lab8> ./main 1 110
...
``` bash
the220th@mainPC ~/git/etu2022_SP_Linux/lab8> ./main 2 110
There was an attachment to the queue with key = 110. Its id = 74. 
